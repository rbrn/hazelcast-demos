 ...
 */
@Service
public class CustomersMapStoreWithMetadta implements com.hazelcast.core.MapStore<Long, Customer> {

    private CustomerDao customerDao;

    @Autowired
    public CustomersMapStoreWithMetadta(CustomerDao customerDao) {
